package br.com.rleite.algamoney.api._base.security.token;
...
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken> {
	...
	@Override
	public OAuth2AccessToken beforeBodyWrite(OAuth2AccessToken body, MethodParameter returnType, MediaType mediaType,
	...
	private void addRefreshTokenInCookie(String refreshToken, HttpServletRequest req, HttpServletResponse res) {
		...
		refreshTokenCookie.setSecure(apiProperty.isEnableHttps());
